// https://assignments-c03.jonas.io/destructuring-arrays.html#1-4
const books = [
  {
    title: 'Algorithms',
...
// normal array fetch method
const fBook = books[0];
const sBook = books[1];

// --------------------------------------------------------------------------=---------------------------
// console.log(fBook, sBook);
// Destructure array
...
({ title: bookAuthor, author: bookAuthor } = books[0]);
...
const printBookInfo = ({ title, author, year = 'unknowwn' }) => {
