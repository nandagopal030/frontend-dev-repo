...
const players1Final = [...allPlayers, 'Thiago', 'Cpitinho', 'perisic'];
...
//     console.log(
//       `${playerNames[scored][i]} has scored ${playerNames[i].score} goals`
//     );
//   }
// }
// printGoals(game);
...
team1 < team2 && console.log('Team1 is likelu to win');
team2 < team1 && console.log('Team2 is likelu to win');
