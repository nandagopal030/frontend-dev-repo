...
TEST DATA: Images in the img folder. Test the error handler by passing a wrong image
 path. Set the network speed to 'Fast 3G' in the dev tools Network tab, otherwise 
...
createImage('img/img-1.jpg')
    ...
    .catch(err => new Error('error plz check'));
